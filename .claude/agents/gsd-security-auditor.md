...
**Verification depth scales with `asvs_level`** (see @/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
