...
<reference>
@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/user-profiling.md` to load:
