...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/kartsi/PycharmProjects/women-app/.claude/.gsd-surface.json`
(sibling to `/home/kartsi/PycharmProjects/women-app/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/kartsi/PycharmProjects/women-app/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/kartsi/PycharmProjects/women-app/.claude/skills`).
...
`/home/kartsi/PycharmProjects/women-app/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/kartsi/PycharmProjects/women-app/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/kartsi/PycharmProjects/women-app/.claude/.gsd-surface.json`
Install profile marker: `/home/kartsi/PycharmProjects/women-app/.claude/.gsd-profile`
Skill dirs: `/home/kartsi/PycharmProjects/women-app/.claude/skills/gsd-*/`
Engine module: `/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
