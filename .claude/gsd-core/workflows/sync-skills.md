...
INSTALL_JS_GLOBAL="/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/kartsi/PycharmProjects/women-app/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
