...
ones). Reference: @/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/kartsi/PycharmProjects/women-app/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/kartsi/PycharmProjects/women-app/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/templates/spec.md.
