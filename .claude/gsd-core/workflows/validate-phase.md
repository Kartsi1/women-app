...
```
Agent(
  prompt="Read /home/kartsi/PycharmProjects/women-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/templates/VALIDATION.md`
