...
<required_reading>
@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/ai-frameworks.md
@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/kartsi/PycharmProjects/women-app/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/kartsi/PycharmProjects/women-app/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/kartsi/PycharmProjects/women-app/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/kartsi/PycharmProjects/women-app/.claude/agents/gsd-eval-planner.md for instructions.
