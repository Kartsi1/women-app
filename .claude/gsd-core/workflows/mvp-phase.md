...
<required_reading>
@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/user-story-template.md
@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/spidr-splitting.md
@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
