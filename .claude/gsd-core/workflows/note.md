...
- **Global scope**: `/home/kartsi/PycharmProjects/women-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/kartsi/PycharmProjects/women-app/.claude/notes/`)
...
2. Glob `/home/kartsi/PycharmProjects/women-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/kartsi/PycharmProjects/women-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/kartsi/PycharmProjects/women-app/.claude/notes/` — works in any directory
