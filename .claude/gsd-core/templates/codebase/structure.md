...
- Usage: Reference from command with `@/home/kartsi/PycharmProjects/women-app/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/kartsi/PycharmProjects/women-app/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/kartsi/PycharmProjects/women-app/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
